#ifndef RUNKEEPEREXPORTERCONFIG_H
#define RUNKEEPEREXPORTERCONFIG_H

#include "iexporterconfig.h"


class RunKeeperExporterConfig : public IExporterConfig
{
public:
    RunKeeperExporterConfig(const QString & serial);
...
#endif // RUNKEEPEREXPORTERCONFIG_H
